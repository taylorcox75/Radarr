...
class FileEditModalContent extends Component {
  ...
  render() {
    ...
    const indexerFlagOptions = indexerFlags.map(({ id, name }) => {
      return {
        key: id,
        value: name
      };
              ...
              <Form>
                ...
                <FormGroup>
                  ...
                  <FormInputGroup
                    type={inputTypes.SELECT}
                    name="indexerFlagIds"
                    value={indexerFlagIds}
                    values={indexerFlagOptions}
                    onChange={this.onInputChange}
                  />
                </FormGroup>
...
FileEditModalContent.propTypes = {
  ...
  indexerFlagIds: PropTypes.arrayOf(PropTypes.number).isRequired,
